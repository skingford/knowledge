      ...
      '/architecture/': [
        {
          ...
          items: [
            ...
            { text: '架构面试准备清单', link: '/architecture/architect-interview-prep-checklist' },
      ...
      '/golang/': [
        {
          ...
          items: [
            ...
            { text: '面试资料完整大纲', link: '/golang/golang-interview-outline' },
            { text: '30 个高频面试题', link: '/golang/go-top-30-interview-questions' },
            { text: '标准面试回答模板', link: '/golang/go-standard-answer-templates' },
            { text: '源码与原理知识点', link: '/golang/go-source-and-principle-notes' },
            { text: '面试高频题代码片段', link: '/golang/go-interview-code-snippets' },
