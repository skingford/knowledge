...
const K8sOverviewDiagrams = defineAsyncComponent(() => import('./k8s/K8sOverviewDiagrams.vue'))
const K8sNetworkDiagrams = defineAsyncComponent(() => import('./k8s/K8sNetworkDiagrams.vue'))
const K8sWorkloadDiagrams = defineAsyncComponent(() => import('./k8s/K8sWorkloadDiagrams.vue'))
const K8sSchedulingResourceDiagrams = defineAsyncComponent(() => import('./k8s/K8sSchedulingResourceDiagrams.vue'))
const K8sSecurityDiagrams = defineAsyncComponent(() => import('./k8s/K8sSecurityDiagrams.vue'))
const K8sStorageControlPlaneDiagrams = defineAsyncComponent(() => import('./k8s/K8sStorageControlPlaneDiagrams.vue'))
const K8sTrafficIngressDiagrams = defineAsyncComponent(() => import('./k8s/K8sTrafficIngressDiagrams.vue'))
const K8sConfigSecretAuditDiagrams = defineAsyncComponent(() => import('./k8s/K8sConfigSecretAuditDiagrams.vue'))
const K8sNodeLifecycleDiagrams = defineAsyncComponent(() => import('./k8s/K8sNodeLifecycleDiagrams.vue'))
const K8sServiceMeshRuntimeDiagrams = defineAsyncComponent(() => import('./k8s/K8sServiceMeshRuntimeDiagrams.vue'))
const K8sServiceDiscoveryDiagrams = defineAsyncComponent(() => import('./k8s/K8sServiceDiscoveryDiagrams.vue'))
const K8sDisruptionSchedulingDiagrams = defineAsyncComponent(() => import('./k8s/K8sDisruptionSchedulingDiagrams.vue'))
const K8sAutoscalingHaDiagrams = defineAsyncComponent(() => import('./k8s/K8sAutoscalingHaDiagrams.vue'))
