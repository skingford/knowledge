  ...
  },
  {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: false,
        items: [
          { text: '总览：包全景图', link: '/golang/guide/source-reading/' },
          ...
          { text: 'encoding/binary：二进制编解码', link: '/golang/guide/source-reading/encoding-binary' },
          ...
          { text: 'log/slog：结构化日志', link: '/golang/guide/source-reading/log-slog-deep' },
          { text: 'mime/multipart：文件上传', link: '/golang/guide/source-reading/mime-multipart' },
          ...
          { text: 'database/sql：连接池与事务', link: '/golang/guide/source-reading/database-sql' },
          { text: 'crypto/tls：TLS 握手与证书', link: '/golang/guide/source-reading/crypto-tls' },
          ...
          { text: 'math/rand/v2（Go 1.22+）：现代随机数', link: '/golang/guide/source-reading/math-rand-v2' },
          ...
          { text: 'Go Fuzzing：覆盖率引导模糊测试', link: '/golang/guide/source-reading/go-fuzzing' },
          ...
          { text: 'Go 内存管理调优', link: '/golang/guide/source-reading/go-memory-tuning' },
          ...
          { text: 'zap：高性能结构化日志', link: '/golang/guide/source-reading/zap' },
