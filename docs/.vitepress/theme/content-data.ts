  ...
  },
  {
    ...
    landing: {
      ...
      docs: [
        ...
        { title: 'AI / IM / 云原生面试专题', href: '/architecture/ai-im-k8s-architecture-interview-guide', description: '围绕 Go、MySQL、Redis、Kafka、AI 工程化、IM/直播和 K8s，整理一套适合高级后端岗位准备的面试主线。' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'AI / IM / 云原生面试专题', link: '/architecture/ai-im-k8s-architecture-interview-guide' },
