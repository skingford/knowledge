...
export const sections: SectionConfig[] = [
  ...
  },
  {
    ...
    landing: {
      ...
      primary: { title: 'Gemini CLI 使用指南', href: '/tools/gemini-cli', description: '整理安装、认证、settings.json、GEMINI.md、MCP、skills、subagents 与自动化用法。' },
      ...
      order: ['Claude Code 使用指南', 'Codex 使用指南', 'Gemini CLI 使用指南', 'Vim 实用方案', 'iTerm2 配置指南', 'Git 常用技巧', 'Mac 效率工具'],
    },
    sidebar: [
      {
        text: '工具',
