  ...
  },
  {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: '基础架构与日志', link: '/mysql/mysql45-basics' },
          { text: '索引原理与优化', link: '/mysql/mysql45-index' },
          { text: '锁与事务', link: '/mysql/mysql45-lock-transaction' },
          { text: '数据页与 IO', link: '/mysql/mysql45-flush-io' },
          { text: 'SQL 查询优化', link: '/mysql/mysql45-query-optimization' },
          { text: '高可用与主从复制', link: '/mysql/mysql45-high-availability' },
          { text: '运维与故障处理', link: '/mysql/mysql45-operation-maintenance' },
          { text: '引擎与进阶', link: '/mysql/mysql45-engine-advanced' },
        ],
      },
    ],
  },
