...
const asyncGlobalComponents = {
  ...
  HcScaleOutDiagram: () => import('@docs-components/HcScaleOutDiagram.vue'),
  HcCacheDiagram: () => import('@docs-components/HcCacheDiagram.vue'),
  HcDatabaseDiagram: () => import('@docs-components/HcDatabaseDiagram.vue'),
  HcAsyncDiagram: () => import('@docs-components/HcAsyncDiagram.vue'),
  HcRateLimitDiagram: () => import('@docs-components/HcRateLimitDiagram.vue'),
  HcMetricsDiagram: () => import('@docs-components/HcMetricsDiagram.vue'),
  HcPrinciplesDiagram: () => import('@docs-components/HcPrinciplesDiagram.vue'),
  HcOversellDiagram: () => import('@docs-components/HcOversellDiagram.vue'),
  HcDistLockDiagram: () => import('@docs-components/HcDistLockDiagram.vue'),
  HcIdempotentDiagram: () => import('@docs-components/HcIdempotentDiagram.vue'),
  HcDistTxDiagram: () => import('@docs-components/HcDistTxDiagram.vue'),
  HcHotspotDiagram: () => import('@docs-components/HcHotspotDiagram.vue'),
  HcResourceDiagram: () => import('@docs-components/HcResourceDiagram.vue'),
  HcHaDiagram: () => import('@docs-components/HcHaDiagram.vue'),
  HcPressureDiagram: () => import('@docs-components/HcPressureDiagram.vue'),
  HcObservabilityDiagram: () => import('@docs-components/HcObservabilityDiagram.vue'),
  HcCanaryDiagram: () => import('@docs-components/HcCanaryDiagram.vue'),
  HcSeckillDiagram: () => import('@docs-components/HcSeckillDiagram.vue'),
  HcDistIdDiagram: () => import('@docs-components/HcDistIdDiagram.vue'),
  HcConsistHashDiagram: () => import('@docs-components/HcConsistHashDiagram.vue'),
  HcAntiCheatDiagram: () => import('@docs-components/HcAntiCheatDiagram.vue'),
  HcMicroserviceDiagram: () => import('@docs-components/HcMicroserviceDiagram.vue'),
  HcNetworkDiagram: () => import('@docs-components/HcNetworkDiagram.vue'),
  HcDelayQueueDiagram: () => import('@docs-components/HcDelayQueueDiagram.vue'),
  HcSkewDiagram: () => import('@docs-components/HcSkewDiagram.vue'),
  HcConfigDiagram: () => import('@docs-components/HcConfigDiagram.vue'),
  HcElasticDiagram: () => import('@docs-components/HcElasticDiagram.vue'),
