...
export const aiSection: SectionConfig = {
  ...
  landing: {
    ...
    docs: [
      ...
      { title: '编程 Agent 横向对比：OpenClaw、Hermes-Agent、Claude Code、Codex', href: '/ai/coding-agents-comparison', description: '按运行形态、扩展机制、权限沙箱、记忆与可观测性六维对比主流编程类 Agent。' },
  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '编程 Agent 对比', link: '/ai/coding-agents-comparison' },
