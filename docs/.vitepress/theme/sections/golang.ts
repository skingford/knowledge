...
const golangSourceReadingSidebar: SidebarGroup[] = [
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      { text: 'Eino 源码阅读总览', link: '/golang/guide/source-reading/eino/' },
      { text: '架构与仓库结构', link: '/golang/guide/source-reading/eino/architecture' },
      { text: 'schema：消息与流', link: '/golang/guide/source-reading/eino/schema' },
      { text: 'components：组件抽象总览', link: '/golang/guide/source-reading/eino/components-overview' },
      { text: 'ChatModel：模型调用', link: '/golang/guide/source-reading/eino/chatmodel' },
      { text: 'ChatTemplate：提示模板', link: '/golang/guide/source-reading/eino/chattemplate' },
      { text: 'Tool：工具调用', link: '/golang/guide/source-reading/eino/tool' },
      { text: 'Retriever：检索器', link: '/golang/guide/source-reading/eino/retriever' },
      { text: 'Embedding：向量化', link: '/golang/guide/source-reading/eino/embedding' },
      { text: 'Indexer：索引器', link: '/golang/guide/source-reading/eino/indexer' },
      { text: 'Document：文档加载与切分', link: '/golang/guide/source-reading/eino/document' },
      { text: 'Lambda：函数式组件', link: '/golang/guide/source-reading/eino/lambda' },
      { text: 'compose：编排总览', link: '/golang/guide/source-reading/eino/compose-overview' },
      { text: 'Graph：图编排核心', link: '/golang/guide/source-reading/eino/graph' },
      { text: 'Chain：链式编排', link: '/golang/guide/source-reading/eino/chain' },
      { text: 'Workflow：字段级编排', link: '/golang/guide/source-reading/eino/workflow' },
      { text: 'Stream：流处理内部', link: '/golang/guide/source-reading/eino/stream' },
      { text: 'Callback：回调机制', link: '/golang/guide/source-reading/eino/callback' },
      { text: '类型检查与编译期校验', link: '/golang/guide/source-reading/eino/type-check' },
      { text: 'State：图内共享状态', link: '/golang/guide/source-reading/eino/state' },
      { text: 'eino-ext 适配器模式', link: '/golang/guide/source-reading/eino/ext-adapters' },
      { text: '从源码提炼的最佳实践', link: '/golang/guide/source-reading/eino/best-practices' },
    ],
  },
]
...
export const golangSection: SectionConfig = {
  ...
  landing: {
    ...
    scope: ['Go 语言底层', '并发模型', '性能优化与排障', '服务端工程实践', '能力自检准备', '设计模式与安全', '容器化与云原生', '代码生成与元编程', '标准库源码精读', 'runtime 源码分析', 'LLM 框架源码（eino）'],
    docs: [
      ...
      { title: 'Eino 源码阅读总览', href: '/golang/guide/source-reading/eino/', description: 'CloudWeGo eino LLM 框架的组件抽象、图编排与流处理精读。' },
