...
export const networkSection: SectionConfig = {
  ...
  landing: {
    ...
    primary: { title: '网络必备知识', href: '/network/essential-knowledge', description: '先用一篇总览文把协议、链路和排障框架搭起来。' },
    secondary: { title: 'TCP/IP、HTTP 与 HTTPS 主线', href: '/network/tcp-ip-http-and-https', description: '把最常被问的协议细节和请求链路讲清。' },
    scope: [
      'OSI / TCP/IP 分层模型',
      'IP、路由与 NAT',
      'TCP / UDP 与可靠传输',
