...
export const nodejsSection: SectionConfig = {
  ...
  landing: {
    ...
    docs: [
      ...
      { title: 'Node.js 模块系统、ESM/CommonJS 与 monorepo', href: '/nodejs/module-system-esm-commonjs-and-monorepo-boundaries', description: '把 import/export、require、包导出和 workspace 边界讲成一条工程主线。' },
      ...
      { title: 'Node.js Redis 实战：客户端、Pipeline 与 Lua 边界', href: '/nodejs/redis-client-pipeline-and-lua-practice', description: '围绕客户端复用、连接管理、Pipeline、Lua、热点 Key 和大 Key，整理 Redis 工程主线。' },
      ...
      { title: 'Node.js 配置、日志与可观测性实践', href: '/nodejs/config-logging-tracing-and-observability-practice', description: '把配置收口、结构化日志、request id、trace 和指标观测整理成一条线。' },
      ...
      { title: 'Node.js Feature Flag 与灰度治理实践', href: '/nodejs/feature-flag-and-runtime-governance-practice', description: '围绕运行时开关分层、灰度放量、kill switch、回退降级和观测审计，整理治理主线。' },
      { title: 'Node.js Secrets、密钥与凭证轮换实践', href: '/nodejs/secret-management-and-credential-rotation-practice', description: '围绕运行时注入、脱敏、签名校验、JWK 与 webhook secret 轮换、对象存储凭证与外部 API token 管理，系统整理 Node.js 服务里的 secret 主线。' },
    ...
    order: [
      'Node.js 专题总览',
      'Node.js 模块系统、ESM/CommonJS 与 monorepo',
      'Node.js 运行时、事件循环与性能排障',
      'Node.js 高并发解决方案实践',
      'Node.js 缓存、热点 Key 与缓存一致性实践',
      'Node.js Redis 实战：客户端、Pipeline 与 Lua 边界',
      ...
      'Node.js 配置、日志与可观测性实践',
      'Node.js 监控、告警与压测演练实践',
      'Node.js Feature Flag 与灰度治理实践',
