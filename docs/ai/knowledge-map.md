...
- [编程 Agent 横向对比：OpenClaw、Hermes-Agent、Claude Code、Codex](./coding-agents-comparison.md)
...
- 编程 Agent 对比：[编程 Agent 横向对比：OpenClaw、Hermes-Agent、Claude Code、Codex](./coding-agents-comparison.md)
