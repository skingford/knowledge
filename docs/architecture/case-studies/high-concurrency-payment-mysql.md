...
| 大事务拆分 | 事务范围过大 → 锁持有长、回滚成本高 | [进入](/mysql/large-transaction-splitting) |
...
| 主题 | 链接 |
| --- | --- |
| database/sql 与连接池 | [进入](/mysql/database-sql-and-connection) |
| 事务处理与 SQL 优化 | [进入](/mysql/transaction-and-optimization) |
