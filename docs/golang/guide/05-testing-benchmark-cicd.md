...
::: details 点击展开代码：使用 testify 简化断言
```go
package service
...
::: details 点击展开代码：使用 testify/mock
```go
package service
...
::: details 点击展开代码：TestMain 生命周期管理
```go
package integration
...
::: details 点击展开代码：使用 Testcontainers
```go
package integration
...
::: details 点击展开代码：子 Benchmark 与不同输入规模
```go
...
::: details 点击展开代码：GitHub Actions 基础配置
```yaml
