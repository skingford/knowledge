...
::: details 点击展开代码：signal.Notify 基础用法
```go
package main
...
::: details 点击展开代码：signal.NotifyContext（Go 1.16+）
```go
package main
...
::: details 点击展开代码：完整的 Deployment + Service YAML
```yaml
# deployment.yaml
apiVersion: apps/v1
kind: Deployment
...
::: details 点击展开代码：使用 viper 实现多源配置加载
```go
package main
...
::: details 点击展开代码：对应的 config.yaml
```yaml
...
::: details 点击展开代码：完整的 docker-compose.yml
```yaml
...
::: details 点击展开代码：GitHub Actions 完整工作流
```yaml
...
::: details 点击展开代码：.golangci.yml 配置
```yaml
