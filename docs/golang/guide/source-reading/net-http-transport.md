...
- 想先理解 `net/http` 全景：看 [`/Users/kingford/workspace/github.com/knowledge/docs/golang/guide/source-reading/net-http.md`](./net-http.md)
- 想深入服务端连接生命周期：看 [`/Users/kingford/workspace/github.com/knowledge/docs/golang/guide/source-reading/net-http-server.md`](./net-http-server.md)
