...
**28. Pod 经常 CrashLoopBackOff，应该先看什么？**
...
**30. NetworkPolicy 能解决什么问题，为什么有时“配了没效果”？**
...
**33. `PDB`、`Eviction API` 和 `kubectl drain` 是什么关系？**
