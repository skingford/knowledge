...
**17. HPA、VPA、Cluster Autoscaler 的区别是什么？**

- HPA：横向调副本
- VPA：纵向调单 Pod 资源
- Cluster Autoscaler：调节点数

**18. 为什么有时候副本数够了，系统还是扛不住？**
...
**23. kube-proxy、CNI、CoreDNS 分别做什么？**
...
**24. 为什么 Pod 明明 Running 了，Service 后面还是没后端？**
...
**25. PV、PVC、StorageClass 怎么配合理解？**

- PVC 是应用对存储的申请
- PV 是集群中的卷资源
- StorageClass 决定如何动态创建存储、用什么性能和回收策略

**26. 为什么数据库、消息队列这类组件更常用 StatefulSet？**
...
**27. Pod 经常 CrashLoopBackOff，应该先看什么？**
...
**29. NetworkPolicy 能解决什么问题，为什么有时“配了没效果”？**
