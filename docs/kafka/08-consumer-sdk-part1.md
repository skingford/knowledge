---
title: "深入拆解消息队列 47 讲：消费端：消费者客户端的 SDK 有哪些设计要点？（上）"
description: "极客时间《深入拆解消息队列 47 讲》第 08 讲笔记整理"
---

# 08. 消费端：消费者客户端的 SDK 有哪些设计要点？（上）
...
三种方案的优劣对比如下：在常见的消息队列产品中，Pulsar支持的Share消费模型就是第一种实现思路。Kafka和RocketMQ主要支持第二和第三种实现思路。
