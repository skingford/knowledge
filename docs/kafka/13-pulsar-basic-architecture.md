---
title: "深入拆解消息队列 47 讲：从基础功能拆解 Pulsar 的架构设计与实现"
description: "极客时间《深入拆解消息队列 47 讲》第 13 讲笔记整理"
---

# 13. 从基础功能拆解 Pulsar 的架构设计与实现
...
Pulsar Broker 的网络层是基于 Netty 框架开发实现的，属于业界比较常用的实现方案。如果想了解更多，建议你直接学习 Netty 的网络模型和开发指南，这里就不展开了。当然，你也可以参考我们的 [第03讲](./03-protocol-design.md) 或 [第04讲](./04-network-module.md)。
