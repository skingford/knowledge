...
Kafka 专题最容易先断掉的是“不丢、不乱、不堵”这三条主线。先用下面两张 SVG 图例把整体框架和答题主线看清，再进入快速上手和 47 讲会更顺。
...
| 文档 | 覆盖内容 |
| --- | --- |
| [Kafka 4.2 官方介绍](./official-v42-introduction.md) | 事件流概念、Kafka 三大能力、核心术语（Event / Topic / Partition / Replication）、五大 API |
