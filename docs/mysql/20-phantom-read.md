---
title: "MySQL 实战 45 讲：20. 幻读是什么，幻读有什么问题？"
description: "极客时间《MySQL 实战 45 讲》第 20 讲笔记整理"
---
...
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 1 假设只在 id=5 这一行加行锁</div>
...
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);"><strong>Q1:</strong> SELECT * FROM t WHERE d=5 FOR UPDATE;<br><span style="color:var(--d-green);">结果：(5,5,5)</span></td>
...
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">UPDATE t SET d=5 WHERE id=0;<br><span style="color:var(--d-green);">(OK)</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T3</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);"><strong>Q2:</strong> SELECT * FROM t WHERE d=5 FOR UPDATE;<br><span style="color:var(--d-orange);">结果：id=0, id=5</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T4</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">INSERT INTO t VALUES(1,1,5);<br><span style="color:var(--d-green);">(OK)</span></td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T5</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-warn-bg);border-color:var(--d-warn-border);"><strong>Q3:</strong> SELECT * FROM t WHERE d=5 FOR UPDATE;<br><span style="color:var(--d-orange);font-weight:700;">结果：id=0, id=1, id=5 ← 幻读!</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T6</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">COMMIT;</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
</tbody>
</table>
<div style="margin-top:8px;padding:8px 12px;background:var(--d-warn-bg);border:1px solid var(--d-warn-border);border-radius:4px;font-size:12px;color:var(--d-warn-text);">Q3 读到了 Session C 新插入的 id=1 这一行，这就是<strong>幻读</strong>——前后两次查询同一范围，后一次看到了新插入的行。</div>
</div>
</div>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 2 假设只在 id=5 这一行加行锁——语义被破坏</div>
<table style="width:100%;border-collapse:collapse;font-size:13px;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:6px 8px;width:50px;">时刻</th>
...
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T1</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE d=5 FOR UPDATE;<br><span style="color:var(--d-text-sub);font-size:12px;">意图：锁住所有 d=5 的行</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T2</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-warn-bg);">UPDATE t SET d=5 WHERE id=0;<br>UPDATE t SET c=5 WHERE id=0;<br><span style="color:var(--d-orange);font-weight:600;">OK — 破坏了 A 的锁语义!</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T3</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-warn-bg);">INSERT INTO t VALUES(1,1,5);<br>UPDATE t SET c=5 WHERE id=1;<br><span style="color:var(--d-orange);font-weight:600;">OK — 同样破坏了锁语义!</span></td>
</tr>
</tbody>
</table>
<div style="margin-top:8px;padding:8px 12px;background:var(--d-warn-bg);border:1px solid var(--d-warn-border);border-radius:4px;font-size:12px;color:var(--d-warn-text);">Session A 声明"锁住所有 d=5 的行"，但 Session B 和 C 修改/插入了新的 d=5 行，<strong>语义被破坏</strong>。</div>
</div>
</div>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 3 假设只在 id=5 这一行加行锁——数据一致性问题</div>
<table style="width:100%;border-collapse:collapse;font-size:13px;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:6px 8px;width:50px;">时刻</th>
...
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T1</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE d=5 FOR UPDATE;<br><code style="font-size:12px;">UPDATE t SET d=100 WHERE d=5;</code><br><span style="color:var(--d-text-sub);font-size:12px;">→ (5,5,100)</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T2</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">UPDATE t SET d=5 WHERE id=0;<br>UPDATE t SET c=5 WHERE id=0;<br><span style="color:var(--d-text-sub);font-size:12px;">→ (0,5,5)</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T3</td>
...
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">INSERT INTO t VALUES(1,1,5);<br>UPDATE t SET c=5 WHERE id=1;<br><span style="color:var(--d-text-sub);font-size:12px;">→ (1,5,5)</span></td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T6</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">COMMIT;</td>
...
<div style="margin-top:10px;padding:8px 12px;background:var(--d-warn-bg);border:1px solid var(--d-warn-border);border-radius:4px;font-size:12px;color:var(--d-warn-text);">
<div style="font-weight:700;margin-bottom:4px;">Binlog 回放结果不一致:</div>
<div>数据库实际：(0,5,5)、(1,5,5)、(5,5,100)</div>
<div>Binlog 回放：(0,5,<strong style="color:var(--d-orange);">100</strong>)、(1,5,<strong style="color:var(--d-orange);">100</strong>)、(5,5,100)</div>
<div style="margin-top:4px;">id=0 和 id=1 出现了<strong>数据不一致</strong>!</div>
</div>
</div>
</div>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 4 假设扫描到的行都被加上了行锁</div>
<table style="width:100%;border-collapse:collapse;font-size:13px;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:6px 8px;width:50px;">时刻</th>
...
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T1</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE d=5 FOR UPDATE;<br><code style="font-size:12px;">UPDATE t SET d=100 WHERE d=5;</code><br><span style="color:var(--d-text-sub);font-size:12px;">锁住所有已有行</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T2</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-orange);font-weight:600;">UPDATE t SET d=5 WHERE id=0;<br>→ <strong>blocked!</strong> (等待行锁)</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T3</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-warn-bg);">INSERT INTO t VALUES(1,1,5);<br>UPDATE t SET c=5 WHERE id=1;<br><span style="color:var(--d-orange);font-weight:600;">OK — 新行不存在，加不上锁!</span></td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T6</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;">COMMIT;</td>
...
<div style="margin-top:8px;padding:8px 12px;background:var(--d-warn-bg);border:1px solid var(--d-warn-border);border-radius:4px;font-size:12px;color:var(--d-warn-text);">即使锁住所有已有行，id=1 在 T1 时刻<strong>不存在</strong>，无法加锁。新插入的记录仍然导致<strong>幻读</strong>和 binlog 不一致。</div>
</div>
</div>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:16px;">图 5 表 t 主键索引上的行锁和间隙锁</div>
<svg viewBox="0 0 580 120" style="width:100%;height:auto;">
<!-- Main axis -->
<line x1="20" y1="50" x2="560" y2="50" stroke="var(--d-border)" stroke-width="2"/>
<!-- Arrow at end -->
<polygon points="556,45 565,50 556,55" fill="var(--d-border)"/>
<!-- Gap locks (colored regions between values) -->
<rect x="20" y="38" width="50" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<rect x="100" y="38" width="50" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<rect x="180" y="38" width="60" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<rect x="270" y="38" width="60" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<rect x="360" y="38" width="60" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<rect x="450" y="38" width="60" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<rect x="540" y="38" width="20" height="24" rx="3" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<!-- Row lock dots -->
<circle cx="80" cy="50" r="8" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1.5"/>
<circle cx="160" cy="50" r="8" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1.5"/>
<circle cx="250" cy="50" r="8" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1.5"/>
<circle cx="340" cy="50" r="8" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1.5"/>
<circle cx="430" cy="50" r="8" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1.5"/>
<circle cx="520" cy="50" r="8" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1.5"/>
<!-- Value labels -->
<text x="28" y="30" font-size="11" fill="var(--d-text-muted)" font-family="system-ui,sans-serif">-&#x221E;</text>
<text x="76" y="30" font-size="12" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">0</text>
<text x="156" y="30" font-size="12" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">5</text>
<text x="243" y="30" font-size="12" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">10</text>
<text x="333" y="30" font-size="12" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">15</text>
<text x="423" y="30" font-size="12" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">20</text>
<text x="513" y="30" font-size="12" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">25</text>
<text x="548" y="30" font-size="11" fill="var(--d-text-muted)" font-family="system-ui,sans-serif">+&#x221E;</text>
<!-- Legend -->
<circle cx="140" cy="100" r="6" fill="var(--d-orange)" stroke="var(--d-text)" stroke-width="1"/>
<text x="152" y="104" font-size="12" fill="var(--d-text)" font-family="system-ui,sans-serif">行锁 (Row Lock)</text>
<rect x="290" y="94" width="20" height="12" rx="2" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1" stroke-dasharray="3,2"/>
<text x="316" y="104" font-size="12" fill="var(--d-text)" font-family="system-ui,sans-serif">间隙锁 (Gap Lock)</text>
</svg>
</div>
</div>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:360px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 6 两种行锁间的冲突关系</div>
<table style="width:100%;border-collapse:collapse;font-size:14px;text-align:center;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:10px 12px;"></th>
<th style="border:1px solid var(--d-th-border);padding:10px 12px;">读锁</th>
<th style="border:1px solid var(--d-th-border);padding:10px 12px;">写锁</th>
</tr>
</thead>
<tbody>
<tr>
<td style="border:1px solid var(--d-border);padding:10px 12px;font-weight:700;background:var(--d-th-bg);color:var(--d-th-text);">读锁</td>
<td style="border:1px solid var(--d-border);padding:10px 12px;color:var(--d-green);font-weight:600;">兼容</td>
<td style="border:1px solid var(--d-border);padding:10px 12px;color:var(--d-orange);font-weight:600;">冲突</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:10px 12px;font-weight:700;background:var(--d-th-bg);color:var(--d-th-text);">写锁</td>
<td style="border:1px solid var(--d-border);padding:10px 12px;color:var(--d-orange);font-weight:600;">冲突</td>
<td style="border:1px solid var(--d-border);padding:10px 12px;color:var(--d-orange);font-weight:600;">冲突</td>
</tr>
</tbody>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 7 间隙锁之间不互锁</div>
<table style="width:100%;border-collapse:collapse;font-size:13px;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:6px 8px;width:50px;">时刻</th>
...
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T1</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE c=7<br>LOCK IN SHARE MODE;<br><span style="color:var(--d-blue);font-size:12px;">→ 加间隙锁 (5, 10)</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T2</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE c=7<br>FOR UPDATE;<br><span style="color:var(--d-green);font-size:12px;font-weight:600;">→ 加间隙锁 (5, 10) — OK! 不冲突</span></td>
</tr>
</tbody>
</table>
<div style="margin-top:8px;padding:8px 12px;background:var(--d-blue-bg);border:1px solid var(--d-blue-border);border-radius:4px;font-size:12px;color:var(--d-text);">间隙锁之间<strong>不存在冲突关系</strong>。两个 Session 可以同时对同一个间隙加间隙锁，因为它们的共同目标是保护这个间隙不被插入新记录。</div>
</div>
</div>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 8 间隙锁导致的死锁</div>
<table style="width:100%;border-collapse:collapse;font-size:13px;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:6px 8px;width:50px;">时刻</th>
...
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T1</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE id=9 FOR UPDATE;<br><span style="color:var(--d-blue);font-size:12px;">→ 间隙锁 (5, 10)</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T2</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">SELECT * FROM t WHERE id=9 FOR UPDATE;<br><span style="color:var(--d-green);font-size:12px;font-weight:600;">→ 间隙锁 (5, 10) — OK!</span></td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T3</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-orange);font-weight:600;background:var(--d-warn-bg);">INSERT INTO t VALUES(9,9,9);<br><strong>blocked!</strong><br><span style="font-weight:400;font-size:12px;">被 Session A 的间隙锁阻塞</span></td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T4</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-orange);font-weight:600;background:var(--d-warn-bg);">INSERT INTO t VALUES(9,9,9);<br><strong style="color:var(--d-orange);">Deadlock!</strong><br><span style="font-weight:400;font-size:12px;">被 Session B 的间隙锁阻塞</span></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
</tbody>
</table>
<!-- Deadlock cycle diagram -->
<svg viewBox="0 0 400 100" style="width:100%;max-width:400px;height:auto;margin:12px auto 0;display:block;">
<rect x="30" y="25" width="120" height="40" rx="6" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1.5"/>
<text x="90" y="50" text-anchor="middle" font-size="13" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">Session A</text>
<rect x="250" y="25" width="120" height="40" rx="6" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="1.5"/>
<text x="310" y="50" text-anchor="middle" font-size="13" fill="var(--d-text)" font-weight="600" font-family="system-ui,sans-serif">Session B</text>
<!-- Arrow A -> B (top) -->
<line x1="150" y1="35" x2="250" y2="35" stroke="var(--d-orange)" stroke-width="2" marker-end="url(#arrowOrange)"/>
<text x="200" y="28" text-anchor="middle" font-size="10" fill="var(--d-orange)" font-family="system-ui,sans-serif">INSERT blocked by B</text>
<!-- Arrow B -> A (bottom) -->
<line x1="250" y1="55" x2="150" y2="55" stroke="var(--d-orange)" stroke-width="2" marker-end="url(#arrowOrange)"/>
<text x="200" y="78" text-anchor="middle" font-size="10" fill="var(--d-orange)" font-family="system-ui,sans-serif">INSERT blocked by A</text>
<!-- Deadlock label -->
<text x="200" y="98" text-anchor="middle" font-size="12" fill="var(--d-orange)" font-weight="700" font-family="system-ui,sans-serif">Deadlock!</text>
<defs>
...
<div style="display:flex;justify-content:center;padding:20px 0;">
<div style="font-family:system-ui,sans-serif;max-width:620px;width:100%;">
<div style="text-align:center;font-weight:700;color:var(--d-text);margin-bottom:12px;">图 9 事务进入锁等待状态</div>
<table style="width:100%;border-collapse:collapse;font-size:13px;">
<thead>
<tr style="background:var(--d-th-bg);color:var(--d-th-text);">
<th style="border:1px solid var(--d-th-border);padding:6px 8px;width:50px;">时刻</th>
...
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T1</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;background:var(--d-blue-bg);">BEGIN;<br>SELECT * FROM t WHERE c&gt;=15 AND c&lt;=20<br>ORDER BY c DESC FOR UPDATE;</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr style="background:var(--d-stripe);">
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T2</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-orange);font-weight:600;background:var(--d-warn-bg);">INSERT INTO t VALUES(11,11,11);<br><strong>blocked!</strong></td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
</tr>
<tr>
<td style="border:1px solid var(--d-border);padding:6px 8px;text-align:center;font-weight:600;">T3</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-text-muted);text-align:center;">—</td>
<td style="border:1px solid var(--d-border);padding:6px 8px;color:var(--d-orange);font-weight:600;background:var(--d-warn-bg);">INSERT INTO t VALUES(6,6,6);<br><strong>blocked!</strong></td>
</tr>
</tbody>
</table>
<div style="margin-top:8px;padding:8px 12px;background:var(--d-blue-bg);border:1px solid var(--d-blue-border);border-radius:4px;font-size:12px;color:var(--d-text);">Session A 的查询加了 next-key lock，Session B 和 Session C 的 INSERT 都进入了<strong>锁等待状态</strong>。具体加锁规则将在下一篇文章中详解。</div>
</div>
</div>
