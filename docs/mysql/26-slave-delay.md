...
<MySQLReplicaDelayDiagram kind="replication-flow" />
...
<MySQLReplicaDelayDiagram kind="parallel-model" />
...
<MySQLReplicaDelayDiagram kind="table-dispatch" />
...
<MySQLReplicaDelayDiagram kind="unique-key-conflict" />
...
<MySQLReplicaDelayDiagram kind="master-overlap" />


而按照MariaDB的并行复制策略，备库上的执行效果如图6所示。

<MySQLReplicaDelayDiagram kind="mariadb-wait" />
...
<MySQLReplicaDelayDiagram kind="prepare-window" />
