...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 1 主备流程图</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 260" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <defs>
...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 2 多线程复制模型</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 300" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <defs>
...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 3 按表分发策略</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 200" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <!-- Header -->
...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 4 唯一键冲突示例</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 200" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <!-- Time axis -->
...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 5 主库并行事务示意</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 180" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <!-- Time axis -->
...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 6 MariaDB 并行复制 — 备库串行等待效果</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 340" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <defs>
...
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 7 两阶段提交细化过程</p>
</div>
