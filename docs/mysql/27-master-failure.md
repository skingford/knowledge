---
title: "MySQL 实战 45 讲：27. 主库出问题了，从库怎么办？"
description: "极客时间《MySQL 实战 45 讲》第 27 讲笔记整理"
---
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 280" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <defs>
    <marker id="m1" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6Z" fill="var(--d-text-sub)"/></marker>
    <marker id="m1d" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6Z" fill="var(--d-blue)"/></marker>
  </defs>
  <!-- Master A -->
  <rect x="140" y="20" width="100" height="44" rx="8" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="2"/>
  <text x="190" y="47" text-anchor="middle" font-size="14" font-weight="bold" fill="var(--d-blue)">A (主)</text>
  <!-- A' -->
  <rect x="300" y="20" width="100" height="44" rx="8" fill="var(--d-bg-alt)" stroke="var(--d-border)" stroke-width="1.5"/>
  <text x="350" y="47" text-anchor="middle" font-size="14" font-weight="bold" fill="var(--d-text-sub)">A' (备)</text>
  <!-- A <-> A' bidirectional -->
  <line x1="240" y1="36" x2="296" y2="36" stroke="var(--d-blue)" stroke-width="1.5" stroke-dasharray="6,3" marker-end="url(#m1d)"/>
  <line x1="300" y1="50" x2="244" y2="50" stroke="var(--d-blue)" stroke-width="1.5" stroke-dasharray="6,3" marker-end="url(#m1d)"/>
  <!-- Slaves -->
  <rect x="20" y="160" width="80" height="40" rx="6" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1"/>
  <text x="60" y="184" text-anchor="middle" font-size="13" fill="var(--d-text)">B</text>
  <rect x="130" y="160" width="80" height="40" rx="6" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1"/>
  <text x="170" y="184" text-anchor="middle" font-size="13" fill="var(--d-text)">C</text>
  <rect x="240" y="160" width="80" height="40" rx="6" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1"/>
  <text x="280" y="184" text-anchor="middle" font-size="13" fill="var(--d-text)">D</text>
  <!-- Arrows from A to slaves -->
  <line x1="175" y1="64" x2="60" y2="156" stroke="var(--d-text-sub)" stroke-width="1.5" marker-end="url(#m1)"/>
  <line x1="190" y1="64" x2="170" y2="156" stroke="var(--d-text-sub)" stroke-width="1.5" marker-end="url(#m1)"/>
  <line x1="200" y1="64" x2="280" y2="156" stroke="var(--d-text-sub)" stroke-width="1.5" marker-end="url(#m1)"/>
  <!-- Legend -->
  <line x1="60" y1="240" x2="100" y2="240" stroke="var(--d-blue)" stroke-width="1.5" stroke-dasharray="6,3"/>
  <text x="110" y="244" font-size="10" fill="var(--d-text-muted)">互为主备</text>
  <line x1="200" y1="240" x2="240" y2="240" stroke="var(--d-text-sub)" stroke-width="1.5"/>
  <text x="250" y="244" font-size="10" fill="var(--d-text-muted)">主从复制</text>
</svg>
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 1 一主多从基本结构</p>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 280" style="max-width:580px;width:100%;height:auto;font-family:system-ui,sans-serif">
  <defs>
    <marker id="m2" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6Z" fill="var(--d-text-sub)"/></marker>
  </defs>
  <!-- A (down) -->
  <rect x="140" y="20" width="100" height="44" rx="8" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1" stroke-dasharray="5,4" opacity="0.5"/>
  <text x="190" y="47" text-anchor="middle" font-size="14" fill="var(--d-text-muted)">A (故障)</text>
  <line x1="150" y1="25" x2="230" y2="58" stroke="var(--d-orange)" stroke-width="2"/>
  <line x1="150" y1="58" x2="230" y2="25" stroke="var(--d-orange)" stroke-width="2"/>
  <!-- A' (new master) -->
  <rect x="300" y="20" width="110" height="44" rx="8" fill="var(--d-blue-bg)" stroke="var(--d-blue-border)" stroke-width="2"/>
  <text x="355" y="47" text-anchor="middle" font-size="14" font-weight="bold" fill="var(--d-blue)">A' (新主)</text>
  <!-- Slaves -->
  <rect x="130" y="160" width="80" height="40" rx="6" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1"/>
  <text x="170" y="184" text-anchor="middle" font-size="13" fill="var(--d-text)">B</text>
  <rect x="260" y="160" width="80" height="40" rx="6" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1"/>
  <text x="300" y="184" text-anchor="middle" font-size="13" fill="var(--d-text)">C</text>
  <rect x="370" y="160" width="80" height="40" rx="6" fill="var(--d-bg)" stroke="var(--d-border)" stroke-width="1"/>
  <text x="410" y="184" text-anchor="middle" font-size="13" fill="var(--d-text)">D</text>
  <!-- Arrows from A' to slaves -->
  <line x1="340" y1="64" x2="170" y2="156" stroke="var(--d-text-sub)" stroke-width="1.5" marker-end="url(#m2)"/>
  <line x1="355" y1="64" x2="300" y2="156" stroke="var(--d-text-sub)" stroke-width="1.5" marker-end="url(#m2)"/>
  <line x1="365" y1="64" x2="410" y2="156" stroke="var(--d-text-sub)" stroke-width="1.5" marker-end="url(#m2)"/>
  <!-- Switch annotation -->
  <text x="220" y="120" text-anchor="middle" font-size="11" fill="var(--d-green)" font-weight="bold">B, C, D 改接 A'</text>
  <!-- Legend -->
  <text x="220" y="250" text-anchor="middle" font-size="10" fill="var(--d-text-muted)">主备切换后：A' 成为新主库，B / C / D 重新指向 A'</text>
</svg>
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 2 主备切换后的结构</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<div style="max-width:580px;margin:0 auto;background:var(--d-bg-alt);border:1px solid var(--d-border);border-radius:8px;padding:1em;text-align:left;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace;font-size:0.82em;line-height:1.6;color:var(--d-text)">
<span style="color:var(--d-text-muted)"># at 123</span><br>
<span style="color:var(--d-text-muted)">#191201 10:15:30</span> server id 1 &nbsp;end_log_pos <strong style="color:var(--d-orange)">123</strong> &nbsp;CRC32 0xb502de2a<br>
<span style="color:var(--d-text-dim)"># Position &nbsp;&nbsp;Timestamp &nbsp;&nbsp;Type ...</span>
</div>
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 3 mysqlbinlog 部分输出结果 — end_log_pos 即为同步位点</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<div style="max-width:580px;margin:0 auto;background:var(--d-bg-alt);border:1px solid var(--d-border);border-radius:8px;padding:1em;text-align:left;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace;font-size:0.82em;line-height:1.6;color:var(--d-text)">
SET @@SESSION.GTID_NEXT='<span style="color:var(--d-blue)">server_uuid</span>:<span style="color:var(--d-orange)">1</span>';<br>
CREATE TABLE t (...);<br>
<span style="color:var(--d-text-muted)">/* xid=... */</span><br>
<br>
SET @@SESSION.GTID_NEXT='<span style="color:var(--d-blue)">server_uuid</span>:<span style="color:var(--d-orange)">2</span>';<br>
BEGIN;<br>
INSERT INTO t VALUES(1,1);<br>
COMMIT;
</div>
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 4 初始化数据的 binlog — 每个事务前都有 GTID_NEXT</p>
</div>
...
<div style="text-align:center;margin:1.5em 0">
<div style="max-width:580px;margin:0 auto;background:var(--d-bg-alt);border:1px solid var(--d-border);border-radius:8px;padding:1em;text-align:left;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,monospace;font-size:0.82em;line-height:1.6;color:var(--d-text)">
mysql> <strong>show master status;</strong><br>
+------------------+----------+-----------+------------------+-----------------------------------------------+<br>
| File &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Position | Binlog_Do | Binlog_Ignore_DB | Executed_Gtid_Set &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |<br>
+------------------+----------+-----------+------------------+-----------------------------------------------+<br>
| master-bin.000001| &nbsp;&nbsp;&nbsp;&nbsp;1416 | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | <span style="color:var(--d-blue)">server_uuid</span>:<span style="color:var(--d-orange)">1-2</span>, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|<br>
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | <span style="color:var(--d-green)">aaaaaaaa-cccc-dddd-eeee-ffffffffffff:10</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|<br>
+------------------+----------+-----------+------------------+-----------------------------------------------+
</div>
<p style="color:var(--d-text-muted);font-size:0.9em;margin-top:0.5em">图 5 show master status 结果 — Executed_Gtid_Set 已包含空事务 GTID</p>
</div>
