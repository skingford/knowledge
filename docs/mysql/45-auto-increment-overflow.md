...
<th style="padding:6px 8px;color:var(--d-th-text);text-align:left">Session A (gdb + mysql)</th>
</tr>
</thead>
<tbody>
...
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">create table t(a int) engine=InnoDB;<br>insert into t values(1),(2),(3);</td>
</tr>
...
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px"><span style="color:var(--d-text-muted)"># gdb 设置</span><br>set dict_sys.row_id = 2<sup>48</sup></td>
</tr>
<tr style="background:var(--d-bg)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T3</td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">insert into t values(2);&ensp;<span style="color:var(--d-text-muted)">-- row_id=0</span><br>insert into t values(3);&ensp;<span style="color:var(--d-text-muted)">-- row_id=1</span></td>
</tr>
<tr style="background:var(--d-stripe)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center">T4</td>
<td style="padding:5px 8px;color:var(--d-text);font-family:monospace;font-size:11px">select * from t;</td>
</tr>
</tbody>
</table>
</div>
<div style="margin-top:6px;font-size:12px;color:var(--d-text-sub)">图 1 &ensp;row_id 用完的验证序列</div>
</div>

<div style="text-align:center;max-width:580px;margin:1.5em auto">
<div style="background:var(--d-bg-alt);border:1px solid var(--d-border);border-radius:8px;padding:16px">
<table style="width:100%;border-collapse:collapse;font-family:monospace;font-size:13px">
<thead>
<tr style="border-bottom:2px solid var(--d-th-border)">
<th style="padding:6px 12px;color:var(--d-th-text);text-align:center;background:var(--d-th-bg)">row_id</th>
<th style="padding:6px 12px;color:var(--d-th-text);text-align:center;background:var(--d-th-bg)">a</th>
<th style="padding:6px 12px;color:var(--d-th-text);text-align:left;background:var(--d-th-bg)">说明</th>
</tr>
</thead>
<tbody>
<tr style="background:var(--d-warn-bg)">
<td style="padding:5px 12px;text-align:center;color:var(--d-text);border-bottom:1px solid var(--d-border)">0</td>
<td style="padding:5px 12px;text-align:center;color:var(--d-orange);font-weight:600;border-bottom:1px solid var(--d-border)">2</td>
<td style="padding:5px 12px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border);font-family:system-ui;font-size:11px">T3 插入，覆盖原 a=1</td>
</tr>
<tr style="background:var(--d-warn-bg)">
<td style="padding:5px 12px;text-align:center;color:var(--d-text);border-bottom:1px solid var(--d-border)">1</td>
<td style="padding:5px 12px;text-align:center;color:var(--d-orange);font-weight:600;border-bottom:1px solid var(--d-border)">3</td>
<td style="padding:5px 12px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border);font-family:system-ui;font-size:11px">T3 插入，覆盖原 a=2</td>
</tr>
<tr>
<td style="padding:5px 12px;text-align:center;color:var(--d-text)">2</td>
<td style="padding:5px 12px;text-align:center;color:var(--d-text)">3</td>
<td style="padding:5px 12px;color:var(--d-text-muted);font-family:system-ui;font-size:11px">T1 原始数据，未被覆盖</td>
</tr>
</tbody>
</table>
</div>
<div style="margin-top:6px;font-size:12px;color:var(--d-text-sub)">图 2 &ensp;row_id 用完的效果验证</div>
</div>
...
<tr style="background:var(--d-bg)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T1</td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">begin;<br>select * from t;<br><span style="color:var(--d-text-muted)">(只读事务)</span></td>
<td style="padding:5px 8px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border)"></td>
</tr>
<tr style="background:var(--d-stripe)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T2</td>
<td style="padding:5px 8px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border)"></td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">select trx_id, trx_mysql_thread_id<br>from innodb_trx;<br><span style="color:var(--d-text-muted)">→ trx_id=</span><span style="color:var(--d-orange);font-weight:600">281479271677952</span> <span style="color:var(--d-text-muted)">(很大)</span><br><span style="color:var(--d-text-muted)">→ thread_id=5</span></td>
</tr>
<tr style="background:var(--d-bg)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T3</td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">insert into t values(null);<br><span style="color:var(--d-text-muted)">(分配真正 trx_id)</span></td>
<td style="padding:5px 8px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border)"></td>
</tr>
<tr style="background:var(--d-stripe)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center">T4</td>
<td style="padding:5px 8px;color:var(--d-text-muted)"></td>
<td style="padding:5px 8px;color:var(--d-text);font-family:monospace;font-size:11px">select trx_id, trx_mysql_thread_id<br>from innodb_trx;<br><span style="color:var(--d-text-muted)">→ trx_id=</span><span style="color:var(--d-green);font-weight:600">1289</span> <span style="color:var(--d-text-muted)">(正常值)</span><br><span style="color:var(--d-text-muted)">→ thread_id=5</span></td>
</tr>
</tbody>
</table>
</div>
<div style="margin-top:6px;font-size:12px;color:var(--d-text-sub)">图 3 &ensp;事务的 trx_id</div>
</div>
...
<tbody>
<tr style="background:var(--d-bg)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T0</td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px" colspan="2"><span style="color:var(--d-text-muted)"># gdb 设置 max_trx_id = 2<sup>48</sup> - 1</span></td>
</tr>
<tr style="background:var(--d-stripe)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T1</td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">begin;<br>select * from t;<br><span style="color:var(--d-text-muted)">低水位 = 2<sup>48</sup>-1</span></td>
<td style="padding:5px 8px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border)"></td>
</tr>
<tr style="background:var(--d-bg)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center;border-bottom:1px solid var(--d-border)">T2</td>
<td style="padding:5px 8px;color:var(--d-text-muted);border-bottom:1px solid var(--d-border)"></td>
<td style="padding:5px 8px;color:var(--d-text);border-bottom:1px solid var(--d-border);font-family:monospace;font-size:11px">update t set c=1 where id=1;<br><span style="color:var(--d-text-muted)">trx_id = 2<sup>48</sup>-1</span><br>update t set c=3 where id=1;<br><span style="color:var(--d-orange)">trx_id = 0 (溢出归零)</span></td>
</tr>
<tr style="background:var(--d-stripe)">
<td style="padding:5px 8px;color:var(--d-text-muted);text-align:center">T3</td>
<td style="padding:5px 8px;color:var(--d-text);font-family:monospace;font-size:11px">select * from t;<br><span style="color:var(--d-orange);font-weight:600">→ c=3 (脏读!)</span><br><span style="color:var(--d-text-muted);font-size:10px">trx_id=0 &lt; 低水位，判为可见</span></td>
<td style="padding:5px 8px;color:var(--d-text-muted)"></td>
</tr>
</tbody>
</table>
</div>
<div style="margin-top:6px;font-size:12px;color:var(--d-text-sub)">图 4 &ensp;复现脏读</div>
</div>
