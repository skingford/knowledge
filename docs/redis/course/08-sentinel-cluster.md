---
title: "Redis 核心技术与实战：08. 哨兵集群：哨兵挂了，主从库还能切换吗？"
description: "极客时间《Redis 核心技术与实战》08. 哨兵集群：哨兵挂了，主从库还能切换吗？ 笔记整理"
---
...
::: details 点击展开 `SUBSCRIBE +odown` 示例
```
SUBSCRIBE +odown
```
:::
...
::: details 点击展开 `switch-master` 事件格式
```
