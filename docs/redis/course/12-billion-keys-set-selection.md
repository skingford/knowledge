---
title: "Redis 核心技术与实战：12. 有一亿个keys要统计，应该用哪种集合？"
description: "极客时间《Redis 核心技术与实战》12. 有一亿个keys要统计，应该用哪种集合？ 笔记整理"
---
...
<RedisCourseFigure kind="billion-set-cumulative" />
...
<RedisCourseFigure kind="billion-set-daily" />
...
::: details 点击展开 `SUNIONSTORE` 示例

```
SUNIONSTORE user:iduser:iduser:id:20200803
```
...
::: details 点击展开 `SDIFFSTORE` 示例

```
SDIFFSTORE user:new user:id:20200804user:id
```
...
::: details 点击展开 `SINTERSTORE` 示例

```
SINTERSTORE user:id:rem user:id:20200803user:id:20200804
```
...
<RedisCourseFigure kind="billion-bitmap-and" />
...
<RedisCourseFigure kind="billion-collection-summary" />
