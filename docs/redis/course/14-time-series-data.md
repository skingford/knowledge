---
title: "Redis 核心技术与实战：14. 如何在Redis中保存时间序列数据？"
description: "极客时间《Redis 核心技术与实战》14. 如何在Redis中保存时间序列数据？ 笔记整理"
---
...
<RedisCourseFigure kind="timeseries-hash-query" />
...
::: details 点击展开 `HGET / HMGET` 示例

```
HGET device:temperature202008030905
"25.1"
HMGET device:temperature202008030905202008030907202008030908
1)"25.1"
2)"25.9"
3)"24.9"
```
...
<RedisCourseFigure kind="timeseries-sortedset-range" />
...
```
ZRANGEBYSCORE device:temperature202008030907202008030910
1)"25.9"
2)"24.9"
3)"25.3"
4)"25.2"
...
::: details 点击展开 `TS.RANGE` 聚合示例

```
TS.RANGE device:temperature15964167001596417120AGGREGATION avg180000
