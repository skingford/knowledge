---
title: "Redis 核心技术与实战：15. 消息队列的考验：Redis有哪些解决方案？"
description: "极客时间《Redis 核心技术与实战》15. 消息队列的考验：Redis有哪些解决方案？ 笔记整理"
---
...
<RedisCourseDiagram kind="message-queue-options" />
...
![原文配图 1](https://static001.geekbang.org/resource/image/d7/bc/d79d46ec4aa22bf46fde3ae1a99fc2bc.jpg)

我们一般把消息队列中发送消息的组件称为生产者（例子中的组件 1），把接收消息的组件称为消费者（例子中的组件 2），下图展示了一个通用的消息队列的架构模型：

![原文配图 2](https://static001.geekbang.org/resource/image/f4/62/f470bb957c1faff674c08b1fa65a3a62.jpg)
...
![原文配图 3](https://static001.geekbang.org/resource/image/b0/7c/b0959216cbce7ac383ce206b8884777c.jpg)
...
![原文配图 4](https://static001.geekbang.org/resource/image/50/3d/5045395da08317b546aab7eb698d013d.jpg)
...
```
XREAD BLOCK100STREAMS mqstream1599203861727-0
1)1)"mqstream"
...
```
XREAD block10000streams mqstream $
(nil)
(10.00s)
```
...
```
XREADGROUP group group1 consumer2 streams mqstream0
1)1)"mqstream"
2) (emptylistorset)
```
...
```
XREADGROUP group group2 consumer1 count1streams mqstream >
1)1)"mqstream"
2)1)1)"1599203861727-0"
2)1)"repo"
2)"5"
XREADGROUP group group2 consumer2 count1streams mqstream >
1)1)"mqstream"
2)1)1)"1599274912765-0"
2)1)"repo"
2)"3"
XREADGROUP group group2 consumer3 count1streams mqstream >
1)1)"mqstream"
...
```
XPENDING mqstream group2 - +10consumer2
1)1)"1599274912765-0"
2)"consumer2"
3) (integer)513336
4) (integer)1
...
```
XACK mqstream group21599274912765-0
(integer)1
XPENDING mqstream group2 - +10consumer2
(emptylistorset)
```
...
![原文配图 5](https://static001.geekbang.org/resource/image/b2/14/b2d6581e43f573da6218e790bb8c6814.jpg)
