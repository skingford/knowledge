...
<RedisCourseFigure kind="latency2-overview" />
...
<RedisCourseFigure kind="latency2-aof-fsync" />
...
<RedisCourseFigure kind="latency2-swap" />
...
<RedisCourseFigure kind="latency2-transparent-hugepage" />
...
::: details 点击展开 `no-appendfsync-on-rewrite` 配置
```
