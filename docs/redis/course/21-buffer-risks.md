---
title: "Redis 核心技术与实战：21. 缓冲区：一个可能引发“惨案”的地方"
description: "极客时间《Redis 核心技术与实战》21. 缓冲区：一个可能引发“惨案”的地方 笔记整理"
---
...
![原文配图 1](https://static001.geekbang.org/resource/image/b8/e4/b86be61e91bd7ca207989c220991fce4.jpg)
...
```
CLIENTLIST
id=5addr=127.0.0.1:50487fd=9name= age=4idle=0flags=N db=0sub=0psub=0multi=-1qbuf=26qbuf-free=32742obl=0oll=0omem=0events=r cmd=client
```
...
MONITOR
OK
1600617456.437129[0127.0.0.1:50487]"COMMAND"
1600617477.289667[0127.0.0.1:50487]"info""memory"
```
...
![原文配图 2](https://static001.geekbang.org/resource/image/a3/7a/a39cd9a9f62c547e2069e6977239de7a.jpg)
...
```
configsetclient-output-buffer-limitslave512mb128mb60
```
...
![原文配图 3](https://static001.geekbang.org/resource/image/ae/8f/aedc9b41b31860e283c5d140bdb3318f.jpg)
