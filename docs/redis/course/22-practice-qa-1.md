---
title: "Redis 核心技术与实战：22. 第11～21讲课后思考题答案及常见问题答疑"
description: "极客时间《Redis 核心技术与实战》22. 第11～21讲课后思考题答案及常见问题答疑 笔记整理"
---
...
::: details 点击展开 `HSCAN` 示例

```
HSCAN user0match"103*"100
```
...
::: details 点击展开 `latency-monitor-threshold` 配置

```
configsetlatency-monitor-threshold 1000
```
...
::: details 点击展开 `latency latest` 示例
...
::: details 点击展开 `redis-cli --bigkeys` 示例
...
Biggestsetfound'userid'has5members
Biggest zsetfound'device:temperature'has6members
//统计每种数据类型的总键值个数，占所有键值个数的比例，以及平均大小
4listswith15items (12.50%ofkeys,avgsize3.75)
5hashswith14fields(15.62%ofkeys,avgsize2.80)
10stringswith68bytes(31.25%ofkeys,avgsize6.80)
1streamswith4entries (03.12%ofkeys,avgsize4.00)
7setswith19members (21.88%ofkeys,avgsize2.71)
5zsetswith17members (15.62%ofkeys,avgsize3.40)
```
...
::: details 点击展开 `redis-cli --bigkeys -i` 示例
