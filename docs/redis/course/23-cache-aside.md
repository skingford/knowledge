---
title: "Redis 核心技术与实战：23. 旁路缓存：Redis是如何工作的？"
description: "极客时间《Redis 核心技术与实战》23. 旁路缓存：Redis是如何工作的？ 笔记整理"
---
...
```bash
StringcacheKey = “productid_11010003”;
StringcacheValue = redisCache.get(cacheKey)；
//缓存命中
if( cacheValue != NULL)
returncacheValue;
//缓存缺失
