---
title: "Redis 核心技术与实战：30. 如何使用Redis实现分布式锁？"
description: "极客时间《Redis 核心技术与实战》30. 如何使用Redis实现分布式锁？ 笔记整理"
---
...
<RedisCourseFigure kind="lock-compete" />
...
<RedisCourseFigure kind="lock-release" />
...
SET lock_key unique_value NX PX10000
```
...
::: details 点击展开 Lua 解锁执行命令

```
redis-cli --evalunlock.script lock_key , unique_value
```
