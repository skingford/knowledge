...
<RedisCourseFigure kind="tx-watch-optimistic" />
...
<RedisCourseFigure kind="tx-multi-exec-flow" />
...
<RedisCourseFigure kind="tx-command-error" />
...
<RedisCourseFigure kind="tx-exec-error" />
