...
<RedisCourseFigure kind="codis-architecture" />
...
<RedisCourseFigure kind="codis-request-flow" />
...
<RedisCourseFigure kind="codis-slot-mapping" />
...
<RedisCourseFigure kind="codis-routing-table" />
...
<RedisCourseFigure kind="codis-data-migration" />
...
<RedisCourseFigure kind="codis-add-proxy" />
...
<RedisCourseFigure kind="codis-server-group" />
...
<RedisCourseFigure kind="codis-vs-cluster-table" />
