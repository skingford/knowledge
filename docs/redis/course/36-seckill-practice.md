---
title: "Redis 核心技术与实战：36. Redis支撑秒杀场景的关键技术和实践都有哪些？"
description: "极客时间《Redis 核心技术与实战》36. Redis支撑秒杀场景的关键技术和实践都有哪些？ 笔记整理"
---
...
ifordered + k <= total then
#更新已秒杀的库存量
redis.call("HINCRBY",KEYS[1],"ordered",k)returnk;
end
return0
```
