---
title: "Redis 核心技术与实战：加餐（五）：Redis有哪些好用的运维工具？"
description: "极客时间《Redis 核心技术与实战》加餐（五）：Redis有哪些好用的运维工具？ 笔记整理"
---
...
![原文配图 1](https://static001.geekbang.org/resource/image/8f/a8/8fb2ef487fd9b7073fd062d480b220a8.jpg)
...
![原文配图 2](https://static001.geekbang.org/resource/image/02/5b/027f6ae0276d483650ee4d5179f19c5b.jpg)
...
CacheCloud是搜狐开发的一个面向 Redis 运维管理的云平台，它**实现了主从集群、哨兵集群和 Redis Cluster 的自动部署和管理**，用户可以直接在平台的管理界面上进行操作。
